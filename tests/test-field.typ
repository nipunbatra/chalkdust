// field — smoke tests: heatmap / contour / surface render without error
...
// sibling optim package (tested in test-optim.typ).
...
// contour: auto levels, explicit levels, filled, and an optim path + marks
