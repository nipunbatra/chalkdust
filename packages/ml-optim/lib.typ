// ml-optim — small numerical optimization in Typst.
//
...
// — hand the path straight to `ml-field.contour(paths:)`.
//
...
#import "@local/ml-random:0.1.0" as rnd   // seeded PRNG for SGD gradient noise
