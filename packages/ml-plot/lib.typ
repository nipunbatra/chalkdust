// ml-plot — general bar & line plots for ML/DL teaching. Native Typst on CeTZ,
// themed through ml-theme (semantic colors, so one override restyles every plot).
//
// Design rules (shared with tensor-grid):
...
//  · everything flows through the semantic theme dict (see ml-theme)
//
