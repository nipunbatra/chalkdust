...
Shared design tokens for the ml diagram package family (`convgrid`,
`plot`, `nn-arch`, `plate-note`). Colors are semantic roles — `ink`,
...
```typst
#import "@local/theme:0.1.0": theme, default-theme
