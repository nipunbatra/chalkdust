// ml-theme — shared design tokens for the ml diagram package family.
//
// Every sibling package (tensor-grid, ml-plot, nn-arch, plate-note) takes a
...
//
//   #import "@local/ml-theme:0.1.0": default-theme, theme
